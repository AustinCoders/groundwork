...
export const BADGES: Badge[] = [
  ...
  },
  {
    ...
    icon: "💯",
    earned: (s) => s.exercisesSolved >= 100,
  },
  {
    id: "read-10",
    name: "Bookworm",
  ...
  },
  {
    id: "reviewer",
    name: "Reviewer",
    description: "Complete 10 spaced reviews.",
    icon: "🔁",
    earned: (s) => s.totalReviews >= 10,
  },

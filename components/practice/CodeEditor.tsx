...
const cmTheme = EditorView.theme({
  ...
  ".cm-activeLine": { backgroundColor: "rgba(205, 214, 244, 0.06)" },
  ".cm-activeLineGutter": { backgroundColor: "rgba(205, 214, 244, 0.06)", color: "var(--ide-accent)", fontWeight: "700" },
  ...
  ".cm-panels": { backgroundColor: "var(--ide-bg-elevated)", color: "var(--ide-fg)", fontFamily: "var(--font-mono)" },

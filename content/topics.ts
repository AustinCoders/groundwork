      ...
      syllabus: [
        ...
        },
        {
          ...
          items: [
            ...
            "A fresh context per call: parameters, arguments, and what outlives it",
            "The outer reference: a first look at the scope chain",
          ],
        },
        {
          ...
          items: [
            "Created, initialised, assigned: the three moments of a binding",
            "Function scope vs block scope, and the braces that fool you",
            "Shadowing, and the TDZ trap hiding inside it",
            "The TDZ is about time, not position",
            "const locks the name, not the value; Object.freeze is shallow",
            "Redeclaration is a parse-time error",
            "Loops: one box vs a fresh box per iteration",
            "The top of a file: window, shared script scope, modules",
          ],
        },
        {
          title: "Scope",
          chapter: "scope",
          items: [
            "Scope vs lifetime vs this: three different questions",
            "Every kind of scope: global, script, module, function, block, and the hidden ones",
            "Lexical vs dynamic scope, and the [[Environment]] link behind it",
            "The lookup, step by step: outward only, never sideways, first match wins",
            "Shadowing, and reaching a shadowed global",
            "Writes walk the chain too: implicit globals and strict mode",
            "Scope as privacy: IIFE, blocks, modules",
            "What bends scope: eval, with, new Function",
          ],
        },
        {
      ...
      syllabus: [
        {
          ...
          items: [
            "Function declarations inside blocks: sloppy vs strict",
            "Default parameters and their own scope",
            "Named function expressions, and the spec's two environments",
            "A closure is the same lookup, still working",
            "Arrows and this through the scope chain; new beats bind",
            "fn.length, fn.name",
        ...
        },
        {
          ...
          syllabus: [
            ...
            },
            {
              ...
              items: ["46 questions by level, and 20 output drills"],
            },
          ],
        },
      ],
